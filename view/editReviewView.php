 ...
 <!-- content -->  
  ...
  <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" name="comments" id="comments" value="<?php echo $review_comments ?>"></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="ODC">Exportada</label>
      <input type="text" class="form-control" name="exported" id="exported" value="<?php echo $review_exported ?>">
    </div>
    <button type="submit" class="btn btn-primary" name="EditAReview">Añadir</button>
